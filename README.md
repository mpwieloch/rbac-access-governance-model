...
**Purpose:** Personal project demonstrating identity and access governance methodology, built to complement hands-on IAM administration experience. This project's findings are operationalized in a companion project: [Microsoft Entra ID Identity Lifecycle Management](https://github.com/mpwieloch/Entra-ID-JML-lifecycle), which implements the access model below in a live Entra ID tenant.
